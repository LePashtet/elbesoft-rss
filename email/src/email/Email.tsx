        ...
        <Section>
          ...
          >
            <Text style={{ textAlign: "center" }}>
              Dear User! Your subscription expires in 30 days. <a style={{ color: "rgb(18, 109, 43)"}} href="/app/subscribe">Keep me receive daily gems</a>
            </Text>
          </Container>
          <Row
            style={{
          ...
          >
            <Row style={{ height: "100%" }}>
              ...
              >
                ...
                >
                  <Text style={{ fontSize: "13px", lineHeight: "21.5px" }}>
                      You received this email because you signed up for News + Letter or because it is included in your subscription.
                    Want Unsubscribe? Contact hello@happymvp.com
                  </Text>
                </Row>
                <Row
                  style={{
