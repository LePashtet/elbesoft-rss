...
export const formatGraphqlJson = (postJson) => {
    ...
    if (data.is_video) {
        return {data: {img: data.video_url, text: data.edge_media_to_caption.edges[0].node.text}};
    }

    return {data: {img: data.display_url, text: data.edge_media_to_caption.edges[0].node.text}};
};
...
const encodePostRequestData = (shortcode) => {
    ...
    // const encoded = "av=17841420683071427&__d=www&__user=0&__a=1&__req=2&__hs=19803.HYP%3Ainstagram_web_pkg.2.1..0.1&dpr=2&__ccg=UNKNOWN&__rev=1012213355&__s=e1sk4i%3Adxlgn7%3A3qd6s7&__hsi=7348853631076781007&__dyn=7xe5WwlEnwn8K2Wmm0NonwgU7S6EdF8aUco38w5ux609vCwjE1xoswaq0yE6u0nS4o5-1ywOwa90Fw4Hw9O7U2sK0EUjwGzEaE7622362W2K0zE5W0PU1bobodEGdwtU662O0z8c86-3u2WE15E6O1FwlE6PhA6bxy2u6V8aUuw&__csr=l1d7hIjlfFAPEj65cBG-K9JfvUVqHCJLGi9hUZevjx2-t6jgkAWBGfGuVqKUDG8yod9Klx23uEGF9U-2yh0hGCKu8yUxqxqfUfE6Kuq00kZu4IM3hw26O04ew0MlgjwTw2Zo0sKw27EhgkQ&__comet_req=7&fb_dtsg=NAcN8uiRbXLyPosyrDVR6N81aLOAiWpZVt9AEI9z8CEuZuDU083zMsg%3A17864970403026470%3A1662759386&jazoest=26207&lsd=gb8lUVJBgjpAckRwZTxcl4&__spin_r=1012213355&__spin_b=trunk&__spin_t=1711038321&fb_api_caller_class=RelayModern&fb_api_req_friendly_name=PolarisProfilePostsQuery&variables=%7B%22data%22%3A%7B%22count%22%3A12%2C%22include_relationship_info%22%3Atrue%2C%22latest_besties_reel_media%22%3Atrue%2C%22latest_reel_media%22%3Atrue%7D%2C%22username%22%3A%22pab1o.it%22%2C%22__relay_internal__pv__PolarisShareMenurelayprovider%22%3Afalse%7D&server_timestamps=true&doc_id=25454041944186983";
